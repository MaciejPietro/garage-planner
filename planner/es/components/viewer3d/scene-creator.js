...
function addCamera(sceneData, planData, layer, cameraID, catalog, camerasActions) {
    ...
    return catalog
        .getElement(camera.type)
        .render3D(camera, layer, sceneData)
        .then(function (camera3D) {
...
function addCamera360(
    ...
    return catalog
        ...
        .render3D(camera360, layer, sceneData)
        .then(function (camera3603D) {
...
function updateCamera360(
    ...
    var camera360 = layer.getIn(['cameras360', camera360ID]);
    var oldCamera360 = oldSceneData.getIn([
        'layers',
        layer.id,
        'cameras360',
        camera360ID,
