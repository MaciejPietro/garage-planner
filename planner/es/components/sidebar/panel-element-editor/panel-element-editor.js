...
export default function PanelElementEditor(_ref, _ref2) {
  ...
  if (![MODE_IDLE, MODE_2D_ZOOM_IN, MODE_2D_ZOOM_OUT, MODE_2D_PAN, MODE_3D_VIEW, MODE_3D_FIRST_PERSON, MODE_WAITING_DRAWING_LINE, MODE_DRAWING_LINE, MODE_DRAWING_HOLE, MODE_DRAWING_ITEM, MODE_DRAWING_CAMERA, MODE_DRAWING_CAMERA360, MODE_DRAGGING_LINE, MODE_DRAGGING_VERTEX, MODE_DRAGGING_ITEM, MODE_DRAGGING_CAMERA, MODE_DRAGGING_CAMERA360, MODE_DRAGGING_HOLE, MODE_ROTATING_ITEM, MODE_ROTATING_CAMERA, MODE_ROTATING_CAMERA360, MODE_UPLOADING_IMAGE, MODE_FITTING_IMAGE, MODE_RESIZING_CAMERA, MODE_RESIZING_CAMERA360, MODE_RESIZING_ITEM].includes(mode)) return null;
  ...
  var layerRenderer = function layerRenderer(layer) {
    return Seq().concat(layer.lines, layer.holes, layer.areas, layer.items, layer.cameras, layer.cameras360).filter(function (element) {
