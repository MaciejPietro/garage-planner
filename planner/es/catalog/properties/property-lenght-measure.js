...
export default function PropertyLengthMeasure(_ref) {
    ...
    // update _length with unit conversion


    if (_length != length) _length = convert(length).from(UNIT_CENTIMETER).to(_unit);
    console.log('PropertyLengthMeasure', _length, length);
