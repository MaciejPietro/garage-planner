import { TextureLoader, Mesh, RepeatWrapping, Vector2, BoxGeometry, MeshBasicMaterial, Group, MeshLambertMaterial } from 'three';
...
export function buildWall(element, layer, scene, textures) {
    ...
    var frontMaterial = new MeshLambertMaterial({ color: 0xf5f4f4 });
    var backMaterial = new MeshLambertMaterial({ color: 0xf5f4f4 });
