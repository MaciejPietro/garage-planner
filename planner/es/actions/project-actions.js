import { NEW_PROJECT, LOAD_PROJECT, SAVE_PROJECT, OPEN_CATALOG, SELECT_TOOL_EDIT, UNSELECT_ALL, SET_PROPERTIES, SET_ITEMS_ATTRIBUTES, SET_CAMERAS_ATTRIBUTES, SET_CAMERAS360_ATTRIBUTES, SET_LINES_ATTRIBUTES, SET_HOLES_ATTRIBUTES, REMOVE, UNDO, ROLLBACK, SET_PROJECT_PROPERTIES, INIT_CATALOG, UPDATE_MOUSE_COORDS, UPDATE_ZOOM_SCALE, TOGGLE_SNAP, CHANGE_CATALOG_PAGE, GO_BACK_TO_CATALOG_PAGE, THROW_ERROR, THROW_WARNING, COPY_PROPERTIES, PASTE_PROPERTIES, PUSH_LAST_SELECTED_CATALOG_ELEMENT_TO_HISTORY, ALTERATE_STATE, SET_MODE, ADD_HORIZONTAL_GUIDE, ADD_VERTICAL_GUIDE, ADD_CIRCULAR_GUIDE, REMOVE_HORIZONTAL_GUIDE, REMOVE_VERTICAL_GUIDE, REMOVE_CIRCULAR_GUIDE, OPEN_PROJECT_CONFIGURATOR, SET_PROPERTIES_ALL } from '../constants';
...
export function setPropertiesAll(height) {
    return {
        type: SET_PROPERTIES_ALL,
        height: height
    };
}
...
export function setCamerasAttributes(camerasAttributes) {
    camerasAttributes = camerasAttributes.set('rotation', parseFloat(camerasAttributes.get('rotation')));

    return {
        type: SET_CAMERAS_ATTRIBUTES,
        camerasAttributes: camerasAttributes
    };
}
export function setCameras360Attributes(cameras360Attributes) {
    cameras360Attributes = cameras360Attributes.set('rotation', parseFloat(cameras360Attributes.get('rotation')));

    return {
        type: SET_CAMERAS360_ATTRIBUTES,
        cameras360Attributes: cameras360Attributes
    };
}
