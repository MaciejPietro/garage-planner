...
exports.default = function (state, action) {
    switch (action.type) {
        ...
        case _constants.SET_PROPERTIES_ALL:
            ...
            Object.keys(lines).forEach(function (lineID) {
                ...
                var newProps = properties.set('height', (0, _immutable.Map)().set('length', action.height));
        ...
        case _constants.SET_CAMERAS_ATTRIBUTES:
            state = state.merge({
                sceneHistory: _export.history.historyPush(state.sceneHistory, state.scene)
            });
            return _export2.Project.setCamerasAttributes(state, action.camerasAttributes).updatedState;

        case _constants.SET_CAMERAS360_ATTRIBUTES:
            state = state.merge({
                sceneHistory: _export.history.historyPush(state.sceneHistory, state.scene)
            });
            return _export2.Project.setCameras360Attributes(state, action.cameras360Attributes).updatedState;
