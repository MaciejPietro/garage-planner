...
function appReducer(state, action) {
  ...
  if (_constants.CAMERAS_ACTIONS[action.type]) return _export.ReactPlannerCamerasReducer.apply(undefined, arguments);
  if (_constants.CAMERAS360_ACTIONS[action.type]) return _export.ReactPlannerCameras360Reducer.apply(undefined, arguments);
