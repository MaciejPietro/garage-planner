...
exports.checkCrossProduct = checkCrossProduct;
exports.findPointOnLineByPointAndAngle = findPointOnLineByPointAndAngle;
exports.calculatePointFromLineWithAngleAndPoint = calculatePointFromLineWithAngleAndPoint;
...
function checkCrossProduct(linePoint1, linePoint2, currentPoint) {
 ...
 *  @return {object}
 */
function findPointOnLineByPointAndAngle(x, y, angle, distance) {
 ...
 * @param currentPointY
 */
function calculatePointFromLineWithAngleAndPoint(startingLinePointX, startingLinePointY, lineAngle, currentPointX, currentPointY) {
  ...
  var A = new _three.Vector3(currentPointX, currentPointY, 0);
  var B = new _three.Vector3(extremeMaxPoint.x, extremeMaxPoint.y, 0); // line base point 1
  var C = new _three.Vector3(extremeMinPoint.x, extremeMinPoint.y, 0); // line base point 2

  var line = new _three.Line3(B, C);
