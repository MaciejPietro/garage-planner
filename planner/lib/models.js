...
exports.State = exports.HistoryStructure = exports.Catalog = exports.CatalogElement = exports.Scene = exports.DefaultLayers = exports.Group = exports.Layer = exports.Camera360 = exports.Camera = exports.Item = exports.Area = exports.Hole = exports.Line = exports.Vertex = exports.ElementsSet = exports.DefaultGrids = exports.Grid = undefined;
...
var DefaultGrids = exports.DefaultGrids = new _immutable.Map({
    h1: new Grid({
        ...
        properties: {
            step: 20,
            colors: ['#b8a4a4', '#f2f2f2', '#f2f2f2', '#f2f2f2', '#f2f2f2']
        }
    }),
    v1: new Grid({
        id: 'v1',
...
var ElementsSet = exports.ElementsSet = function (_Record2) {
    ...
    function ElementsSet() {
        ...
        return _possibleConstructorReturn(this, (ElementsSet.__proto__ || Object.getPrototypeOf(ElementsSet)).call(this, {
            ...
            cameras: new _immutable.List(json.cameras || []),
            cameras360: new _immutable.List(json.cameras360 || [])
        }));
    }
    ...
    cameras: new _immutable.List(),
    cameras360: new _immutable.List()
}, 'ElementsSet'));
...
var Camera = exports.Camera = function (_Record8) {
    _inherits(Camera, _Record8);
    ...
    function Camera() {
        ...
        return _possibleConstructorReturn(this, (Camera.__proto__ || Object.getPrototypeOf(Camera)).call(this, _extends({}, json, {
            properties: (0, _immutable.fromJS)(json.properties || {})
        })));
    }
...
var Camera360 = exports.Camera360 = function (_Record9) {
    _inherits(Camera360, _Record9);
    ...
    function Camera360() {
        ...
        return _possibleConstructorReturn(this, (Camera360.__proto__ || Object.getPrototypeOf(Camera360)).call(this, _extends({}, json, {
            properties: (0, _immutable.fromJS)(json.properties || {})
        })));
    }
...
var Layer = exports.Layer = function (_Record10) {
    _inherits(Layer, _Record10);
    ...
    function Layer() {
        ...
        return _possibleConstructorReturn(this, (Layer.__proto__ || Object.getPrototypeOf(Layer)).call(this, _extends({}, json, {
            ...
            cameras: safeLoadMapList(json.cameras, Camera),
            cameras360: safeLoadMapList(json.cameras360, Camera360),
    ...
    cameras: new _immutable.Map(),
    cameras360: new _immutable.Map(),
    selected: new ElementsSet()
}, 'Layer'));

var Group = exports.Group = function (_Record11) {
    _inherits(Group, _Record11);
...
var Scene = exports.Scene = function (_Record12) {
    _inherits(Scene, _Record12);
...
var CatalogElement = exports.CatalogElement = function (_Record13) {
    _inherits(CatalogElement, _Record13);
...
var Catalog = exports.Catalog = function (_Record14) {
    _inherits(Catalog, _Record14);
    ...
    _createClass(Catalog, [{
        ...
        value: function factoryElement(type, options, initialProperties) {
            ...
            switch (element.prototype) {
                ...
                case 'cameras':
                    return new Camera(options).merge({ properties: properties });

                case 'cameras360':
                    return new Camera360(options).merge({ properties: properties });
...
var HistoryStructure = exports.HistoryStructure = function (_Record15) {
    _inherits(HistoryStructure, _Record15);
...
var State = exports.State = function (_Record16) {
    _inherits(State, _Record16);
    ...
    function State() {
        ...
        return _possibleConstructorReturn(this, (State.__proto__ || Object.getPrototypeOf(State)).call(this, _extends({}, json, {
            ...
            resizingSupport: new _immutable.Map(json.resizingSupport || {}),
    ...
    resizingSupport: new _immutable.Map(),
