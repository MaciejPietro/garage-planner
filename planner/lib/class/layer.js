    ...
    _createClass(Layer, null, [{
        ...
        value: function unselectAll(state, layerID) {
            ...
            if (cameras) cameras.forEach(function (camera) {
                state = _export.Camera.unselect(state, layerID, camera.id).updatedState;
            });
            if (cameras360) cameras360.forEach(function (camera360) {
                state = _export.Camera360.unselect(state, layerID, camera360.id).updatedState;
            });
        ...
        value: function setPropertiesOnSelected(state, layerID, properties) {
            ...
            selected.cameras.forEach(function (cameraID) {
                return state = _export.Camera.setProperties(state, layerID, cameraID, properties).updatedState;
            });
            selected.cameras360.forEach(function (camera360ID) {
                return state = _export.Camera360.setProperties(state, layerID, camera360ID, properties).updatedState;
            });
        ...
        value: function updatePropertiesOnSelected(state, layerID, properties) {
            ...
            selected.cameras.forEach(function (cameraID) {
                return state = _export.Camera.updateProperties(state, layerID, cameraID, properties).updatedState;
            });
            selected.cameras360.forEach(function (camera360ID) {
                return state = _export.Camera360.updateProperties(state, layerID, camera360ID, properties).updatedState;
            });
        ...
        value: function setAttributesOnSelected(state, layerID, attributes) {
            ...
            selected.cameras.forEach(function (cameraID) {
                return state = _export.Camera.setAttributes(state, layerID, cameraID, attributes).updatedState;
            });
            selected.cameras360.forEach(function (camera360ID) {
                return state = _export.Camera360.setAttributes(state, layerID, camera360ID, attributes).updatedState;
            });
