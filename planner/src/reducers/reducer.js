...
import {
  ...
  ReactPlannerCamerasReducer,
  ReactPlannerCameras360Reducer
} from './export';
...
export default function appReducer(state, action) {
  ...
  if( CAMERAS_ACTIONS[action.type] ) return ReactPlannerCamerasReducer(...arguments);
  if( CAMERAS360_ACTIONS[action.type] ) return ReactPlannerCameras360Reducer(...arguments);
