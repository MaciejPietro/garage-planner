...
function Sidebar(_ref) {
    ...
    var multiselected = selected.lines.size > 1 || selected.items.size > 1 || selected.cameras.size > 1 || selected.cameras360.size > 1 || selected.holes.size > 1 || selected.areas.size > 1 || selected.lines.size + selected.items.size + selected.cameras.size + selected.cameras360.size + selected.holes.size + selected.areas.size > 1;
    ...
    return _react2.default.createElement(
        'aside',
        {
            style: _extends({ width: width, maxHeight: height }, STYLE),
