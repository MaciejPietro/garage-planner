    ...
    _createClass(ElementEditor, [{
        ...
        value: function initAttrData(element, layer, state) {
            ...
            switch (element.prototype) {
                ...
                case 'lines':
                    {
                        console.log('initAttrData', element, layer, state);
        ...
        value: function updateProperty(propertyName, value) {
            ...
            console.log('updateProperty', propertiesFormData);
        ...
        value: function save(_ref2) {
            ...
            if (propertiesFormData) {
                console.log('save:propertiesFormData', propertiesFormData);
                var properties = propertiesFormData.map(function (data) {
                    console.log('mapa', data.get('currentValue'));
            ...
            if (attributesFormData) {
                switch (this.props.element.prototype) {
                    ...
                    case 'cameras':
                        {
                            this.context.projectActions.setCamerasAttributes(attributesFormData);
                            break;
                        }
                    case 'cameras360':
                        {
                            this.context.projectActions.setCameras360Attributes(attributesFormData);
                            break;
                        }
                    case 'lines':
                        {
