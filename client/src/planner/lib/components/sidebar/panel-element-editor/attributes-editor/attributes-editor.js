...
var _cameraAttributesEditor = require('./camera-attributes-editor');

var _cameraAttributesEditor2 = _interopRequireDefault(_cameraAttributesEditor);

var _camera360AttributesEditor = require('./camera360-attributes-editor');

var _camera360AttributesEditor2 = _interopRequireDefault(_camera360AttributesEditor);
...
function AttributesEditor(_ref) {
  ...
  switch (element.prototype) {
    ...
    case 'cameras':
      return _react2.default.createElement(_cameraAttributesEditor2.default, _extends({
        element: element,
        onUpdate: onUpdate,
        onValid: onValid,
        attributeFormData: attributeFormData,
    ...
    case 'cameras360':
      return _react2.default.createElement(_camera360AttributesEditor2.default, _extends({
        element: element,
        onUpdate: onUpdate,
        onValid: onValid,
        attributeFormData: attributeFormData,
