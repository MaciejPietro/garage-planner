...
import {
  ...
  MODE_WAITING_DRAWING_LINE, MODE_DRAWING_LINE, MODE_DRAWING_HOLE, MODE_DRAWING_CAMERA, MODE_DRAWING_CAMERA360, MODE_DRAWING_ITEM, MODE_DRAGGING_LINE,
  ...
  MODE_ROTATING_ITEM, MODE_ROTATING_CAMERA, MODE_ROTATING_CAMERA360
} from '../../../constants';
...
//export default function PanelMultiElementsEditor({state}, {projectActions, translator}) {
  ...
  render() {
    ...
    if (![MODE_IDLE, MODE_2D_ZOOM_IN, MODE_2D_ZOOM_OUT, MODE_2D_PAN,
      ...
      MODE_ROTATING_ITEM, MODE_ROTATING_CAMERA, MODE_ROTATING_CAMERA360, MODE_UPLOADING_IMAGE, MODE_FITTING_IMAGE].includes(mode)) return null;
