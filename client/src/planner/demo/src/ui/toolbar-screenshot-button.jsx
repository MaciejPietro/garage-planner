...
export default function ToolbarScreenshotButton({ mode }) {
    ...
    if ([MODE_3D_VIEW].includes(mode)) {
        return (
            <ToolbarButton active={false} tooltip='Zapisz jako obraz' onClick={saveScreenshotToFile}>
                <MdCamera />
            </ToolbarButton>
        );
    }
    ...
    if (
        ...
        return (
            <ToolbarButton active={false} tooltip='Zapisz jako obraz' onClick={saveSVGScreenshotToFile}>
                <MdCamera />
            </ToolbarButton>
        );
    }
