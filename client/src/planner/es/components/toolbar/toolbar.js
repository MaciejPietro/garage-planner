...
import { MODE_IDLE, MODE_3D_VIEW, MODE_VIEWING_CATALOG, MODE_CONFIGURING_PROJECT } from '../../constants';
        ...
        value: function render() {
                    ...
                    ToolbarButton,
                    {
                        ...
                        onClick: function onClick(event) {
                            ...
                            if (isInIframe) {
                                ...
                                confirm('Would you want to start a new Project') ? projectActions.newProject() : null;
                            }
                        }
                    },
            ...
            // },
            {
                ...
                dom: React.createElement(
                    ...
                    [MODE_3D_VIEW].includes(mode) ? React.createElement(Icon2D, { style: { color: alterateColor } }) : React.createElement(FaMousePointer, { style: { color: alterateColor } })
                )
            }, {
                index: 1,
                condition: true,
                    ...
                    ToolbarButton,
                    {
                        ...
                        onClick: function onClick() {
                            ...
                            if (isInIframe) {
                                ...
                                var _height = prompt('Wysokość ścian');
                                projectActions.setPropertiesAll(parseInt(_height));
                            }
                        }
                    },
                    React.createElement(MdVerticalAlignTop, null)
                )
            }];
