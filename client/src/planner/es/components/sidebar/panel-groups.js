...
var VISIBILITY_MODE = {
  ...
  MODE_WAITING_DRAWING_LINE: MODE_WAITING_DRAWING_LINE, MODE_DRAWING_LINE: MODE_DRAWING_LINE, MODE_DRAWING_HOLE: MODE_DRAWING_HOLE, MODE_DRAWING_ITEM: MODE_DRAWING_ITEM, MODE_DRAWING_CAMERA: MODE_DRAWING_CAMERA, MODE_DRAWING_CAMERA360: MODE_DRAWING_CAMERA360, MODE_DRAGGING_LINE: MODE_DRAGGING_LINE,
  MODE_DRAGGING_VERTEX: MODE_DRAGGING_VERTEX, MODE_DRAGGING_ITEM: MODE_DRAGGING_ITEM, MODE_DRAGGING_CAMERA: MODE_DRAGGING_CAMERA, MODE_DRAGGING_CAMERA360: MODE_DRAGGING_CAMERA360, MODE_DRAGGING_HOLE: MODE_DRAGGING_HOLE, MODE_FITTING_IMAGE: MODE_FITTING_IMAGE, MODE_UPLOADING_IMAGE: MODE_UPLOADING_IMAGE,
  MODE_ROTATING_ITEM: MODE_ROTATING_ITEM, MODE_ROTATING_CAMERA: MODE_ROTATING_CAMERA, MODE_ROTATING_CAMERA360: MODE_ROTATING_CAMERA360
};
              ...
              var chainToGroup = function chainToGroup(e) {
                layers.forEach(function (layer) {
                  ...
                  var layerElements = {
                    ...
                    'cameras': layer.get('cameras'),
                    'cameras360': layer.get('cameras360'),
