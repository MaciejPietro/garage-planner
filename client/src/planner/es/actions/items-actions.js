import { SELECT_ITEM, SELECT_TOOL_DRAWING_ITEM, UPDATE_DRAWING_ITEM, END_DRAWING_ITEM, BEGIN_DRAGGING_ITEM, UPDATE_DRAGGING_ITEM, END_DRAGGING_ITEM, BEGIN_ROTATING_ITEM, UPDATE_ROTATING_ITEM, END_ROTATING_ITEM, BEGIN_RESIZING_ITEM, UPDATE_RESIZING_ITEM, END_RESIZING_ITEM } from '../constants';
...
export function beginResizingItem(layerID, itemID, x, y, side) {
  return {
    type: BEGIN_RESIZING_ITEM,
    layerID: layerID, itemID: itemID, x: x, y: y, side: side
  };
}

export function updateResizingItem(x, y) {
  return {
    type: UPDATE_RESIZING_ITEM,
    x: x, y: y
  };
}
