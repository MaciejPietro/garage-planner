import { PROJECT_ACTIONS, VIEWER2D_ACTIONS, VIEWER3D_ACTIONS, GROUP_ACTIONS, ITEMS_ACTIONS, CAMERAS_ACTIONS, CAMERAS360_ACTIONS, HOLE_ACTIONS, LINE_ACTIONS, AREA_ACTIONS, SCENE_ACTIONS, VERTEX_ACTIONS } from '../constants';

import { ReactPlannerAreasReducer, ReactPlannerHolesReducer, ReactPlannerItemsReducer, ReactPlannerLinesReducer, ReactPlannerGroupsReducer, ReactPlannerProjectReducer, ReactPlannerSceneReducer, ReactPlannerVerticesReducer, ReactPlannerViewer2dReducer, ReactPlannerViewer3dReducer, ReactPlannerCamerasReducer, ReactPlannerCameras360Reducer } from './export';
...
export default function appReducer(state, action) {
  ...
  if (CAMERAS_ACTIONS[action.type]) return ReactPlannerCamerasReducer.apply(undefined, arguments);
  if (CAMERAS360_ACTIONS[action.type]) return ReactPlannerCameras360Reducer.apply(undefined, arguments);
