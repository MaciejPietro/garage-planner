import { MODE_IDLE, MODE_3D_VIEW, MODE_SNAPPING, KEYBOARD_BUTTON_CODE } from '../constants';
        ...
        window.addEventListener('keydown', function (event) {
            ...
            switch (event.keyCode) {
                ...
                case KEYBOARD_BUTTON_CODE.DELETE:
                    {
                        if ([MODE_IDLE, MODE_3D_VIEW].includes(mode)) store.dispatch(remove());
                        break;
                    }
                ...
                case KEYBOARD_BUTTON_CODE.C:
                    {
                        ...
                        if ((mode === MODE_IDLE || mode === MODE_3D_VIEW) && (selected.holes.size || selected.areas.size || selected.items.size || selected.cameras.size || selected.cameras360.size || selected.lines.size)) {
                            if (selected.holes.size) {
                                ...
                                store.dispatch(copyProperties(camera.properties));
                                ...
                                store.dispatch(copyProperties(camera360.properties));
